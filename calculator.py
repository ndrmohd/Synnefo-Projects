...
getresult=Label(f,text='0=',font='calibri 12 bold',fg='#A5A5A5',bg='#D3D3D3').place(x=280,y=40)
toview=Label(f,text='0',font='calibri 35 bold',bg='#D3D3D3').place(x=280,y=65)
...
seven=Button(f,text='𝟳',font="20",width='8',height='3',border='0',bg='#F5F5F5').place(x=0,y=307)
eight=Button(f,text='𝟴',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=80,y=307)
nine=Button(f,text='𝟵',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=160,y=307)
multiplication=Button(f,text='✖',font='20',width='8',height='3',border='0',bg='#E1E1E1').place(x=240,y=307)

four=Button(f,text='𝟰',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=0,y=373)
five=Button(f,text='𝟱',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=80,y=373)
six=Button(f,text='𝟲',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=160,y=373)
substraction=Button(f,text='➖',font='20',width='8',height='3',border='0',bg='#E1E1E1').place(x=240,y=373)

one=Button(f,text='𝟭',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=0,y=439)
two=Button(f,text='𝟮',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=80,y=439)
three=Button(f,text='𝟯',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=160,y=439)
...
zero=Button(f,text='𝟬',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=80,y=505)
dot=Button(f,text='•',font='20',width='8',height='3',border='0',bg='#F5F5F5').place(x=160,y=505)
equal=Button(f,text='＝',font='20',width='8',height='3',border='0',bg='#E1E1E1').place(x=240,y=505)
